...
export const PREMISE = (
  <div>
    Suddenly the sky cracks with a flash. A winged figure descends upon you. The
    figure introduces himself, &quot;Greetings mortal, I&apos;m the Angel of
    Music. I have five questions for you. Complete them, and I&apos;ll give you
    a reward.&quot;
  </div>
);
...
export const QUESTIONS = [
  ...
  },
  {
    id: 2,
    question:
      "Next, pick a creature from the musical spirit realm world to guide you:",
    answers: [
      {
        entry: "a",
        id: "2a",
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        id: "4b",
        answer:
          'A rustic acoustic guitar with "this machine kills fascists" written on it',
        type: THINKER,
      },
      {
        entry: "c",
  ...
  [CRUISER]: {
    blurb: (
      <div>
        <div>&quot;&quot;&quot;</div>
        <div>
          Your musical personality is like a smooth cruise down the coastal
          highway. Your songs capture the sweet feeling of an uninhibited
          spirit.
        </div>
        <div>&quot;&quot;&quot;</div>
      </div>
    ...
    Embed: CruiserEmbed,
    playlistLink:
      "https://open.spotify.com/playlist/29ngmUyX5axVriFSTyQy7R?si=bd389a57586b4a92",
  },
  [ROCKER]: {
    blurb: (
      <div>
        <div>&quot;&quot;&quot;</div>
        <div>
          Your musical personality is relentless and invigorating, like the
          energy from hair-rising guitar amps. The sound of your songs crash and
          screech with a beautiful brand of chaotic musicality.
        </div>
        <div>&quot;&quot;&quot;</div>
      </div>
    ),
    Embed: RockerEmbed,
    playlistLink:
      "https://open.spotify.com/playlist/1njREE782p2UmiVsuKQBu3?si=f87ff77aec36484c",
  },
  [ROMANTIC]: {
    blurb: (
      <div>
        <div>&quot;&quot;&quot;</div>
        <div>
          Your musical personality is warm and buttery. When you listen to your
          music, it&apos;s like drinking the foam on a warm latte. Or it can be
          like a passionate embrace amidst an evening&apos;s candlelight.
        </div>
        <div>&quot;&quot;&quot;</div>
      </div>
    ),
    Embed: RomanticEmbed,
    playlistLink:
      "https://open.spotify.com/playlist/3TMHZHFF7hlQbFYCWqbHrt?si=04de917f8c6d4c2a",
  },
  [THINKER]: {
    blurb: (
      <div>
        <div>&quot;&quot;&quot;</div>
        <div>
          Your musical personality consists of wit and discovery. Your songs
          traverse the world of ideas. Your curious mind craves the sound of
          thought-provoking compositions and challenge of meaningful lyrics.
        </div>
        <div>&quot;&quot;&quot;</div>
      </div>
    ),
    Embed: ThinkerEmbed,
    playlistLink:
      "https://open.spotify.com/playlist/01vuz1uxoDgn1FpJ5bvYtS?si=eb184710c18d4b7a",
  },
};

export const CONCLUSION_PART_2 = (
  <div>Here is a playlist that matches your personality.</div>
);

export const CONCLUSION_PART_3 = (
  <div>
    Once again, the sky cracks with a flash. The Angel of Music begins to
    ascend, &quot;Until we meet again. Hope you enjoy the playlist. Oh, and one
    more thing: don&apos;t forget to{" "}
    <a
      href="https://open.spotify.com/artist/6ep6Hvwexmaa5IqcPxMxqC?si=qY9-ObwmQzikC-T7mB-WGw"
      target="_blank"
      className="link"
    >
      support and follow my favorite mortal artist on Spotify: David Kando.
    </a>
    &quot;
  </div>
);
